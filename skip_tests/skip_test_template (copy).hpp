...
Map<Key_T, Mapped_T>::SkipList::                  // XXX
...
// print_list
template<typename Key_T, typename Mapped_T>	
void Map<Key_T, Mapped_T>::SkipList::                  // XXX
print_list(const typename Map<Key_T, Mapped_T>::SkipList::Node &sent, bool frwd){     
...
template<typename Key_T, typename Mapped_T>	
void Map<Key_T, Mapped_T>::SkipList::                  // XXX
pretty_print_dnode(typename Map<Key_T, Mapped_T>::SkipList::Node* n){ 
...
template<typename Key_T, typename Mapped_T>	
void Map<Key_T, Mapped_T>::SkipList::                  // XXX
insert(typename Map<Key_T, Mapped_T>::SkipList::Node* n){                   // XXX
...
// erase(Key)
template<typename Key_T, typename Mapped_T>	
bool Map<Key_T, Mapped_T>::SkipList::                  // XXX
...
// get_rand_height()
template<typename Key_T, typename Mapped_T>	
unsigned int Map<Key_T, Mapped_T>::SkipList::                  // XXX
get_rand_height(){
...
// XXX Node(height) XXX
template<typename Key_T, typename Mapped_T>	
Map<Key_T, Mapped_T>::SkipList::Node::                  // XXX
...
// constructor
template<typename Key_T, typename Mapped_T>	
Map<Key_T, Mapped_T>::SkipList::DataNode::                  // XXX
...
// copy_value
template<typename Key_T, typename Mapped_T>	
typename Map<Key_T, Mapped_T>::SkipList::ValueType                   // XXX
Map<Key_T, Mapped_T>::SkipList::DataNode::                  // XXX
...
// Node debug
template<typename Key_T, typename Mapped_T>
void Map<Key_T, Mapped_T>::SkipList::Node::                  // XXX
_print_trace(std::string fn, bool focus) const {
	if(this->__print_trace){	
		if(focus){
			std::cout << "Node\t";
...
// DataNode debug
template<typename Key_T, typename Mapped_T>
void Map<Key_T, Mapped_T>::SkipList::DataNode::                  // XXX
